...
|---|---|
| [`bento convert`](/cli/convert) | Run the conversion pipeline against a file or directory. |
| [`bento config`](/cli/config) | Print the fully resolved config with per-field provenance. Does not encode. |
| [`bento check`](/cli/check) | Verify external dependencies and the global config. |
| [`bento repair`](/cli/repair) | Populate missing fields in the global config with current defaults. |
...
See [Flags](/cli/flags) for the complete flag reference.
